...
const debug = DBG("raddict:posts_comments-sequelize");
const error = DBG("raddict:posts_error-sequelize");
...
export async function postComment(from, gravatar, namespace, comment, timestamp) {
